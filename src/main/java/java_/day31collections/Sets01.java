...
public class Sets01 {
    ...
    public static void main(String[] args) {
        ...
        lhs.retainAll(ls);// iki listin ortak elemanlarını alır ortak olmanyanları siler
        ...
        System.out.println(ts.higher('R'));//U verilen elemandan sonraki elemanı verir
        System.out.println(ts.higher('T'));//U

        System.out.println(ts.headSet('R'));//[A, G] verilen elemandan önceki diğer elemanları verir.
        System.out.println(ts.headSet('R',true));//[A, G, R]

        System.out.println(ts.tailSet('R'));//[R, U, Z] verilen eleman dahil sonrasını al.
        System.out.println(ts.tailSet('R',false));//[ U, Z]

        System.out.println(ts.ceiling('R'));//R ==> eleman setin içinde varsa elemanın kendisini return eder
        System.out.println(ts.ceiling('T'));//U ==> eleman setin içinde yoksa sonraki elemanı return eder

        System.out.println(ts.floor('G'));//G ==> eleman setin içinde varsa elemanın kendisini return eder
        System.out.println(ts.floor('T'));//R ==> eleman setin içinde yoksa önceki elemanı return eder

        System.out.println(ts.subSet('G', 'Z'));//[G, R, U] ==> ilk parametre dahil ikinci parametre hariç.
