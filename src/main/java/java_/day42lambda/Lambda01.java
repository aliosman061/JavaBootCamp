...
public class Lambda01 {
    ...
    public static boolean isLengthMoreThanTwo (List<String>names){//allMatch() methodu tum elemanlarda verilen sarta gore karsilastirma yapar.Tamami ortusuyorsa true degilse false verir
